...
Migration.prototype.defaultTypeScriptTemplate = function () {
  return [
    '',
    'let dbm;',
    'let type;',
...
Migration.prototype.getTemplate = function() {
  switch (this.templateType) {
    ...
    case Migration.TemplateType.DEFAULT_TYPE_SCRIPT:
      return this.defaultTypeScriptTemplate();
