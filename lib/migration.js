...
Migration.prototype.defaultCoffeeTemplate = function () {
  return [
    ...
    'seed = undefined',
    '',
    'exports.setup = (internals, seedLink) ->',
    '  dbm = internals.migrationOptions.dbmigrate',
    '  type = dbm.dataType',
    '  seed = seedLink',
    '',
    'exports.up = (db) ->',
...
Migration.prototype.defaultJsTemplate = function () {
  return [
    ...
    '  */',
    'exports.setup = function(internals, seedLink) {',
    '  dbm = internals.migrationOptions.dbmigrate;',
    '  type = dbm.dataType;',
    '  seed = seedLink;',
    '};',
...
Migration.prototype.sqlFileLoaderTemplate = function () {
  return [
    ...
    '  type = dbm.dataType;',
    '  seed = seedLink;',
    '  Promise = internals.migrationOptions.Promise;',
    '};',
    '',
    'exports.up = function(db) {',
...
Migration.prototype.sqlFileLoaderIgnoreOnInitTemplate = function () {
  return [
    ...
    'exports.setup = function(internals, seedLink) {',
    '  dbm = internals.migrationOptions.dbmigrate;',
    '  ignoreOnInit = internals.migrationOptions.ignoreOnInit;',
    '  type = dbm.dataType;',
    '  seed = seedLink;',
    '  Promise = internals.migrationOptions.Promise;',
    '};',
