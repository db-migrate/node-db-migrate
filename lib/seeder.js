...
Seeder.prototype = {
  ...
  upToBy: function(partialName, count, callback) {
    ...
    return Seed.loadFromFilesystem(self.seedDir, function(err, allMigrations) {
      ...
      return Migration.loadFromDatabase(self.seedDir, self._driver, function(err, completedMigrations) {
  ...
  downToBy: function(count, callback) {
    var self = this;
    Seed.loadFromDatabase(self.seedDir, self._driver, function(err, completedMigrations) {
