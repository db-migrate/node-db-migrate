...
Migrator.prototype = {
  ...
  writeMigrationRecord: function(migration, callback) {
    ...
    this.driver.addMigrationRecord(migration.name, global.migrationTable, onComplete);
  },
  ...
  deleteMigrationRecord: function(migration, callback) {
    function onComplete(err) {
      ...
      callback(err);
		...
		this.driver.deleteMigration(migration.name, global.migrationTable, onComplete);
  },
