...
var MongodbDriver = Base.extend({
   ...
   * @param migrationCollection - The name of the migration collection
   * @param callback
   */
  addMigrationRecord: function (name, migrationCollection, callback) {
    this._run('insert', migrationCollection, {name: name, run_on: new Date}, callback);
  },
   ...
   * @param callback
   */
  allLoadedMigrations: function(migrationCollection, callback) {
    this._run('find', migrationCollection, null, callback);
  },
   ...
   * @param callback
   */
  deleteMigration: function(migrationName, migrationCollection, callback) {
    this._run('remove', migrationCollection, {toRemove: migrationName}, callback);
  },
