...
exports.connect = function(config, callback) {
  ...
  db = config.db || new MongoClient(new Server(host, port, options));
  console.log(db);
  var mongodbDriver = new MongodbDriver(db, mongoString);
  mongodbDriver.serverOptions = options;
  callback(null, mongodbDriver);
};
