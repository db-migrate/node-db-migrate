...
exports.connect = function(config, callback) {
  ...
  var options = {
    ...
    socketOptions: {
      connectTimeoutMS: config.MONGO_CONNECT_TIMEOUT || 10 * 1000,
      socketTimeoutMS: config.MONGO_SOCKET_TIMEOUT || 10 * 1000
    },
    ssl: true,
    sslValidate: true,
  ...
  if(config.replSet !== undefined) {
    servers = config.replSet.split(',').map(function(member) {
      return new Server(member, port, options);
    });
  } else {
