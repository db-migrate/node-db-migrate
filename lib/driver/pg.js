...
var PgDriver = Base.extend({
    ...
    createMigrationsTable: function(callback) {
      ...
      return this.runSql('select version() as version')
      .then(function(result) {
        ...
        // if necessary
        return this.runSql("SHOW search_path");
      }.bind(this))
      .then(function(result) {
          ...
          return this.runSql('SET search_path TO ' + searchPath);
        }.bind(this))
        .then(function() {

            return this.runSql("SELECT table_name FROM information_schema.tables WHERE table_name = '" + internals.migrationTable + "'");
        }.bind(this))
        .then(function(result) {

          if (result && result.rows && result.rows.length < 1) {
            return this.testTable(internals.migrationTable, options);
          } else {
    ...
    testTable: function(tableName, options, callback) {
