...
module.exports = Base = Class.extend({
  ...
  createMigrationsTable: function(callback) {
    ...
    this._createTable('migrations', options, callback);
  },

  _getErrorWithSqlCallback: function(sql, callback) {
    return function(err, results) {
      if(err) {
        err = { sql: sql, error: err };
      }
  ...
  _createTable: function(tableName, options, callback) {
    ...
    this._runSql(sql, this._getErrorWithSqlCallback(sql, callback));
  },
