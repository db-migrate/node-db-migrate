...
exports.reduceToInterface = function(db, originInterface) {
  ...
  for(var prop in db) {
    ...
    if (typeof db[prop] === "function") {
      ...
      Interface[prop] = originInterface[prop];
    }
  }
  ...
  for(var prop in originInterface.deprecated) {
    ...
    if (typeof db[prop] === "function" &&
      ...
      (function(property) {
        ...
        this._original[property].apply(this, arguments);
      };
      }(prop));
    }
    else if(typeof originInterface[prop] === "function") {
  ...
  for(var prop in originInterface.extend) {
    ...
    if (typeof db[prop] === "function" &&
        typeof originInterface.extend[prop] === "function") {

      Interface[prop] = originInterface.extend[prop];
    }
    else if(typeof originInterface[prop] === "function") {
